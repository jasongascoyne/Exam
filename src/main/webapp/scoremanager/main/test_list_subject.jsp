				...
				<table class="table table-hover">
					...
					<c:forEach var="test" items="${list}">
						<tr>
							...
							<td>
								<%= ((bean.TestListSubject)pageContext.getAttribute("test")).getPoints().get(1) != null
									? ((bean.TestListSubject)pageContext.getAttribute("test")).getPoints().get(1)
									: "-" %>
							</td>
							<td>
								<%= ((bean.TestListSubject)pageContext.getAttribute("test")).getPoints().get(2) != null
									? ((bean.TestListSubject)pageContext.getAttribute("test")).getPoints().get(2)
									: "-" %>
							</td>
						</tr>
					</c:forEach>
